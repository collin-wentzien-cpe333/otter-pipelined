...
//////////////////////////////////////////////////////////////////////////////////
  ...
  module Memory (
    ...
    input [31:0] MEM_ADDR2, // Data Memory Addr (MEM stage - writes, sizing, MMIO)
    input [31:0] MEM_ADDR2_EARLY, // Data Memory Addr (EX stage - early BRAM read)
    ...
    always_ff @(posedge MEM_CLK) begin
      ...
      if (weAddrValid == 1) begin  //(MEM_WE == 1) && (MEM_ADDR2 < 16'hFFFD)) begin   // write enable and valid address space
        ...
        if(MEM_RDEN2)                         // Read word from memory (early addr)
            memReadWord <= memory[MEM_ADDR2_EARLY[15:2]];
    end
