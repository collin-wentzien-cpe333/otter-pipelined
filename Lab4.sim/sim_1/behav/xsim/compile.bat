...
REM
REM Generated by Vivado on Thu Jan 29 22:22:29 -0800 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_pipeline_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_pipeline_vlog.prj -log xvlog.log
